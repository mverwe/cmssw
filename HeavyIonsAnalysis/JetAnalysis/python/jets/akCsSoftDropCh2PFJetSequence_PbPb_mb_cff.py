...
#akCsSoftDropCh2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))

akCsSoftDropCh2PFbTagger = bTaggers("akCsSoftDropCh2PF",0.2)

#create objects locally since they dont load properly otherwise
#akCsSoftDropCh2PFmatch = akCsSoftDropCh2PFbTagger.match
akCsSoftDropCh2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDropCh2PFJets"), matched = cms.InputTag("selectedPartons"))
...
akCsSoftDropCh2PFJetSequence = cms.Sequence(akCsSoftDropCh2PFJetSequence_mb)
