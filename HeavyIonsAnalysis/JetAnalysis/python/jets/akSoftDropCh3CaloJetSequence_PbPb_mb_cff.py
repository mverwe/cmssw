...
#akSoftDropCh3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))

akSoftDropCh3CalobTagger = bTaggers("akSoftDropCh3Calo",0.3)

#create objects locally since they dont load properly otherwise
#akSoftDropCh3Calomatch = akSoftDropCh3CalobTagger.match
akSoftDropCh3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh3CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akSoftDropCh3CaloJetSequence = cms.Sequence(akSoftDropCh3CaloJetSequence_mb)
