...
#akCsSoftDropCh5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiSignalGenJets'))

akCsSoftDropCh5PFbTagger = bTaggers("akCsSoftDropCh5PF",0.5)

#create objects locally since they dont load properly otherwise
#akCsSoftDropCh5PFmatch = akCsSoftDropCh5PFbTagger.match
akCsSoftDropCh5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDropCh5PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCsSoftDropCh5PFJetSequence = cms.Sequence(akCsSoftDropCh5PFJetSequence_jec)
akCsSoftDropCh5PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsSoftDropCh5PFJetAnalyzer.jetPtMin = cms.double(1)
