...
akCsSoftDropCh2PFJetSequence = cms.Sequence(akCsSoftDropCh2PFJetSequence_jec)
akCsSoftDropCh2PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsSoftDropCh2PFJetAnalyzer.jetPtMin = cms.double(1)
