...
#akSoftDropCh1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1GenJets'))

akSoftDropCh1CalobTagger = bTaggers("akSoftDropCh1Calo",0.1)

#create objects locally since they dont load properly otherwise
#akSoftDropCh1Calomatch = akSoftDropCh1CalobTagger.match
akSoftDropCh1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh1CaloJets"), matched = cms.InputTag("genParticles"))
