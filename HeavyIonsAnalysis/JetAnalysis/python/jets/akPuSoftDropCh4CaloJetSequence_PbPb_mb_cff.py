...
#akPuSoftDropCh4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))
...
akPuSoftDropCh4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh4CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDropCh4CaloJetSequence = cms.Sequence(akPuSoftDropCh4CaloJetSequence_mb)
