...
#akCsSoftDropCh6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))

akCsSoftDropCh6PFbTagger = bTaggers("akCsSoftDropCh6PF",0.6)

#create objects locally since they dont load properly otherwise
#akCsSoftDropCh6PFmatch = akCsSoftDropCh6PFbTagger.match
akCsSoftDropCh6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDropCh6PFJets"), matched = cms.InputTag("selectedPartons"))
...
akCsSoftDropCh6PFJetSequence = cms.Sequence(akCsSoftDropCh6PFJetSequence_mb)
