...
#akVsSoftDropCh1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1GenJets'))

akVsSoftDropCh1PFbTagger = bTaggers("akVsSoftDropCh1PF",0.1)

#create objects locally since they dont load properly otherwise
#akVsSoftDropCh1PFmatch = akVsSoftDropCh1PFbTagger.match
akVsSoftDropCh1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh1PFJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDropCh1PFJetSequence = cms.Sequence(akVsSoftDropCh1PFJetSequence_jec)
akVsSoftDropCh1PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropCh1PFJetAnalyzer.jetPtMin = cms.double(1)
