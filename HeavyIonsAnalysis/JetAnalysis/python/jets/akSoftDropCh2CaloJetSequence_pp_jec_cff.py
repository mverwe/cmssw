...
#akSoftDropCh2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2GenJets'))

akSoftDropCh2CalobTagger = bTaggers("akSoftDropCh2Calo",0.2)

#create objects locally since they dont load properly otherwise
#akSoftDropCh2Calomatch = akSoftDropCh2CalobTagger.match
akSoftDropCh2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh2CaloJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropCh2CaloJetSequence = cms.Sequence(akSoftDropCh2CaloJetSequence_jec)
akSoftDropCh2CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropCh2CaloJetAnalyzer.jetPtMin = cms.double(1)
