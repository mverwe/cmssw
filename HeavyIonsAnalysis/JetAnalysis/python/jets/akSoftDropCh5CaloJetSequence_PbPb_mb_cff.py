...
#akSoftDropCh5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akSoftDropCh5CalobTagger = bTaggers("akSoftDropCh5Calo",0.5)

#create objects locally since they dont load properly otherwise
#akSoftDropCh5Calomatch = akSoftDropCh5CalobTagger.match
akSoftDropCh5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh5CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akSoftDropCh5CaloJetSequence = cms.Sequence(akSoftDropCh5CaloJetSequence_mb)
