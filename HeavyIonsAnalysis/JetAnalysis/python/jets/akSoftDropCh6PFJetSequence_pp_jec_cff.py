...
#akSoftDropCh6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))

akSoftDropCh6PFbTagger = bTaggers("akSoftDropCh6PF",0.6)

#create objects locally since they dont load properly otherwise
#akSoftDropCh6PFmatch = akSoftDropCh6PFbTagger.match
akSoftDropCh6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh6PFJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropCh6PFJetSequence = cms.Sequence(akSoftDropCh6PFJetSequence_jec)
akSoftDropCh6PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropCh6PFJetAnalyzer.jetPtMin = cms.double(1)
