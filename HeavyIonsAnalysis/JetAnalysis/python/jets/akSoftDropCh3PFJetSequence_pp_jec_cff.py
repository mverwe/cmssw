...
#akSoftDropCh3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3GenJets'))

akSoftDropCh3PFbTagger = bTaggers("akSoftDropCh3PF",0.3)

#create objects locally since they dont load properly otherwise
#akSoftDropCh3PFmatch = akSoftDropCh3PFbTagger.match
akSoftDropCh3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh3PFJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropCh3PFJetSequence = cms.Sequence(akSoftDropCh3PFJetSequence_jec)
akSoftDropCh3PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropCh3PFJetAnalyzer.jetPtMin = cms.double(1)
