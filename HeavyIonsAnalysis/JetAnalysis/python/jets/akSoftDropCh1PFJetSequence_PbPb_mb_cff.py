...
#akSoftDropCh1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))

akSoftDropCh1PFbTagger = bTaggers("akSoftDropCh1PF",0.1)

#create objects locally since they dont load properly otherwise
#akSoftDropCh1PFmatch = akSoftDropCh1PFbTagger.match
akSoftDropCh1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh1PFJets"), matched = cms.InputTag("selectedPartons"))
...
akSoftDropCh1PFJetSequence = cms.Sequence(akSoftDropCh1PFJetSequence_mb)
