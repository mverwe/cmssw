...
#akPuSoftDropCh4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))

akPuSoftDropCh4PFbTagger = bTaggers("akPuSoftDropCh4PF",0.4)

#create objects locally since they dont load properly otherwise
#akPuSoftDropCh4PFmatch = akPuSoftDropCh4PFbTagger.match
akPuSoftDropCh4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh4PFJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDropCh4PFJetSequence = cms.Sequence(akPuSoftDropCh4PFJetSequence_mb)
