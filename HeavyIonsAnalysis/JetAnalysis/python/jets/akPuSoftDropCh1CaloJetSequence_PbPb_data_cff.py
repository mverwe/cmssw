...
#akPuSoftDropCh1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiSignalGenJets'))
...
akPuSoftDropCh1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh1CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akPuSoftDropCh1CaloJetSequence = cms.Sequence(akPuSoftDropCh1CaloJetSequence_data)
