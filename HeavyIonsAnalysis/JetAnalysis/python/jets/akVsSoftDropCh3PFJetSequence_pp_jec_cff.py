...
#akVsSoftDropCh3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3GenJets'))

akVsSoftDropCh3PFbTagger = bTaggers("akVsSoftDropCh3PF",0.3)

#create objects locally since they dont load properly otherwise
#akVsSoftDropCh3PFmatch = akVsSoftDropCh3PFbTagger.match
akVsSoftDropCh3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh3PFJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDropCh3PFJetSequence = cms.Sequence(akVsSoftDropCh3PFJetSequence_jec)
akVsSoftDropCh3PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropCh3PFJetAnalyzer.jetPtMin = cms.double(1)
