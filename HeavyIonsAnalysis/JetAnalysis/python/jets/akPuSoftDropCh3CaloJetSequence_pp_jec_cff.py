...
#akPuSoftDropCh3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3GenJets'))
...
akPuSoftDropCh3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh3CaloJets"), matched = cms.InputTag("genParticles"))
...
akPuSoftDropCh3CaloJetSequence = cms.Sequence(akPuSoftDropCh3CaloJetSequence_jec)
akPuSoftDropCh3CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuSoftDropCh3CaloJetAnalyzer.jetPtMin = cms.double(1)
