...
#akCsSoftDropCh1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))

akCsSoftDropCh1PFbTagger = bTaggers("akCsSoftDropCh1PF",0.1)

#create objects locally since they dont load properly otherwise
#akCsSoftDropCh1PFmatch = akCsSoftDropCh1PFbTagger.match
akCsSoftDropCh1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDropCh1PFJets"), matched = cms.InputTag("selectedPartons"))
...
akCsSoftDropCh1PFJetSequence = cms.Sequence(akCsSoftDropCh1PFJetSequence_mb)
