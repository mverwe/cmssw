...
#akPuSoftDropCh6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiSignalGenJets'))

akPuSoftDropCh6PFbTagger = bTaggers("akPuSoftDropCh6PF",0.6)

#create objects locally since they dont load properly otherwise
#akPuSoftDropCh6PFmatch = akPuSoftDropCh6PFbTagger.match
akPuSoftDropCh6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh6PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akPuSoftDropCh6PFJetSequence = cms.Sequence(akPuSoftDropCh6PFJetSequence_jec)
akPuSoftDropCh6PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuSoftDropCh6PFJetAnalyzer.jetPtMin = cms.double(1)
