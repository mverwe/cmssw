...
#akSoftDropCh5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))

akSoftDropCh5CalobTagger = bTaggers("akSoftDropCh5Calo",0.5)

#create objects locally since they dont load properly otherwise
#akSoftDropCh5Calomatch = akSoftDropCh5CalobTagger.match
akSoftDropCh5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh5CaloJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropCh5CaloJetSequence = cms.Sequence(akSoftDropCh5CaloJetSequence_jec)
akSoftDropCh5CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropCh5CaloJetAnalyzer.jetPtMin = cms.double(1)
