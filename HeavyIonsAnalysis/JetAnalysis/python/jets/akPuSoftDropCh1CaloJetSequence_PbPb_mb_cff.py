...
#akPuSoftDropCh1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))
...
akPuSoftDropCh1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh1CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDropCh1CaloJetSequence = cms.Sequence(akPuSoftDropCh1CaloJetSequence_mb)
