...
akCsSoftDropCh6PFJetSequence = cms.Sequence(akCsSoftDropCh6PFJetSequence_jec)
akCsSoftDropCh6PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsSoftDropCh6PFJetAnalyzer.jetPtMin = cms.double(1)
