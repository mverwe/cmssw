...
#akSoftDropCh6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))

akSoftDropCh6CalobTagger = bTaggers("akSoftDropCh6Calo",0.6)

#create objects locally since they dont load properly otherwise
#akSoftDropCh6Calomatch = akSoftDropCh6CalobTagger.match
akSoftDropCh6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh6CaloJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropCh6CaloJetSequence = cms.Sequence(akSoftDropCh6CaloJetSequence_jec)
akSoftDropCh6CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropCh6CaloJetAnalyzer.jetPtMin = cms.double(1)
