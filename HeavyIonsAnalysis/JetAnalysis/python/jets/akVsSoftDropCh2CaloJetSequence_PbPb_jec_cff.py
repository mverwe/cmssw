...
#akVsSoftDropCh2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiSignalGenJets'))
...
akVsSoftDropCh2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh2CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsSoftDropCh2CaloJetSequence = cms.Sequence(akVsSoftDropCh2CaloJetSequence_jec)
akVsSoftDropCh2CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropCh2CaloJetAnalyzer.jetPtMin = cms.double(1)
