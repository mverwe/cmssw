...
#akVsSoftDropCh2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))
...
akVsSoftDropCh2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh2CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDropCh2CaloJetSequence = cms.Sequence(akVsSoftDropCh2CaloJetSequence_mb)
