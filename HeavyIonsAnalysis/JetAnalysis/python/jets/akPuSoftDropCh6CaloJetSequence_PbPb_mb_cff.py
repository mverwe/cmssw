...
#akPuSoftDropCh6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))
...
akPuSoftDropCh6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh6CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDropCh6CaloJetSequence = cms.Sequence(akPuSoftDropCh6CaloJetSequence_mb)
