...
#akVsSoftDropCh6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))

akVsSoftDropCh6PFbTagger = bTaggers("akVsSoftDropCh6PF",0.6)

#create objects locally since they dont load properly otherwise
#akVsSoftDropCh6PFmatch = akVsSoftDropCh6PFbTagger.match
akVsSoftDropCh6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh6PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDropCh6PFJetSequence = cms.Sequence(akVsSoftDropCh6PFJetSequence_mb)
