...
#akPuSoftDropCh2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2GenJets'))
...
akPuSoftDropCh2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh2CaloJets"), matched = cms.InputTag("genParticles"))
...
akPuSoftDropCh2CaloJetSequence = cms.Sequence(akPuSoftDropCh2CaloJetSequence_data)
