...
#akVsSoftDropCh3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))
...
akVsSoftDropCh3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh3CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDropCh3CaloJetSequence = cms.Sequence(akVsSoftDropCh3CaloJetSequence_mb)
