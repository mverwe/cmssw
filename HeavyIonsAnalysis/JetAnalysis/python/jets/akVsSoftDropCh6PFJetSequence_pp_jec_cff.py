...
#akVsSoftDropCh6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))

akVsSoftDropCh6PFbTagger = bTaggers("akVsSoftDropCh6PF",0.6)

#create objects locally since they dont load properly otherwise
#akVsSoftDropCh6PFmatch = akVsSoftDropCh6PFbTagger.match
akVsSoftDropCh6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh6PFJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDropCh6PFJetSequence = cms.Sequence(akVsSoftDropCh6PFJetSequence_jec)
akVsSoftDropCh6PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropCh6PFJetAnalyzer.jetPtMin = cms.double(1)
