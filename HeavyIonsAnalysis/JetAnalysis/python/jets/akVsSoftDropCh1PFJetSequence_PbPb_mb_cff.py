...
#akVsSoftDropCh1PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiCleanedGenJets'))

akVsSoftDropCh1PFbTagger = bTaggers("akVsSoftDropCh1PF",0.1)

#create objects locally since they dont load properly otherwise
#akVsSoftDropCh1PFmatch = akVsSoftDropCh1PFbTagger.match
akVsSoftDropCh1PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh1PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDropCh1PFJetSequence = cms.Sequence(akVsSoftDropCh1PFJetSequence_mb)
