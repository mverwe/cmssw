...
#akSoftDropCh5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiSignalGenJets'))

akSoftDropCh5PFbTagger = bTaggers("akSoftDropCh5PF",0.5)

#create objects locally since they dont load properly otherwise
#akSoftDropCh5PFmatch = akSoftDropCh5PFbTagger.match
akSoftDropCh5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh5PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akSoftDropCh5PFJetSequence = cms.Sequence(akSoftDropCh5PFJetSequence_jec)
akSoftDropCh5PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropCh5PFJetAnalyzer.jetPtMin = cms.double(1)
