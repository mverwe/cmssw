...
#akVsSoftDropCh5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))
...
akVsSoftDropCh5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh5CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDropCh5CaloJetSequence = cms.Sequence(akVsSoftDropCh5CaloJetSequence_mb)
