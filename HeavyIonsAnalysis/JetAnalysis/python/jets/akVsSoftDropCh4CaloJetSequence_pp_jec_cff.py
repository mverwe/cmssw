...
#akVsSoftDropCh4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4GenJets'))
...
akVsSoftDropCh4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh4CaloJets"), matched = cms.InputTag("genParticles"))
