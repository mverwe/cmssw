...
#akVsSoftDropCh4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiSignalGenJets'))
...
akVsSoftDropCh4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh4CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsSoftDropCh4CaloJetSequence = cms.Sequence(akVsSoftDropCh4CaloJetSequence_jec)
akVsSoftDropCh4CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropCh4CaloJetAnalyzer.jetPtMin = cms.double(1)
