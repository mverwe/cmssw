...
#akVsSoftDropCh2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2GenJets'))

akVsSoftDropCh2PFbTagger = bTaggers("akVsSoftDropCh2PF",0.2)

#create objects locally since they dont load properly otherwise
#akVsSoftDropCh2PFmatch = akVsSoftDropCh2PFbTagger.match
akVsSoftDropCh2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh2PFJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDropCh2PFJetSequence = cms.Sequence(akVsSoftDropCh2PFJetSequence_data)
