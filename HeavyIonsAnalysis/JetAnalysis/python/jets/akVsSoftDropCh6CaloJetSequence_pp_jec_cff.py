...
#akVsSoftDropCh6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6GenJets'))
...
akVsSoftDropCh6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh6CaloJets"), matched = cms.InputTag("genParticles"))
