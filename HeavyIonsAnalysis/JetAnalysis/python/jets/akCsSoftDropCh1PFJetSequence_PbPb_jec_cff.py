...
akCsSoftDropCh1PFJetSequence = cms.Sequence(akCsSoftDropCh1PFJetSequence_jec)
akCsSoftDropCh1PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsSoftDropCh1PFJetAnalyzer.jetPtMin = cms.double(1)
