...
#akPuSoftDropCh3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))

akPuSoftDropCh3PFbTagger = bTaggers("akPuSoftDropCh3PF",0.3)

#create objects locally since they dont load properly otherwise
#akPuSoftDropCh3PFmatch = akPuSoftDropCh3PFbTagger.match
akPuSoftDropCh3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh3PFJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDropCh3PFJetSequence = cms.Sequence(akPuSoftDropCh3PFJetSequence_mb)
