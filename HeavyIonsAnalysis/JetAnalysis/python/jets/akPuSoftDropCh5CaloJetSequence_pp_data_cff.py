...
#akPuSoftDropCh5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))
...
akPuSoftDropCh5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh5CaloJets"), matched = cms.InputTag("genParticles"))
...
akPuSoftDropCh5CaloJetSequence = cms.Sequence(akPuSoftDropCh5CaloJetSequence_data)
