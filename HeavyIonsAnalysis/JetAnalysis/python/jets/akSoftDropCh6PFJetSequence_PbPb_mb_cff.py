...
#akSoftDropCh6PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiCleanedGenJets'))

akSoftDropCh6PFbTagger = bTaggers("akSoftDropCh6PF",0.6)

#create objects locally since they dont load properly otherwise
#akSoftDropCh6PFmatch = akSoftDropCh6PFbTagger.match
akSoftDropCh6PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh6PFJets"), matched = cms.InputTag("selectedPartons"))
...
akSoftDropCh6PFJetSequence = cms.Sequence(akSoftDropCh6PFJetSequence_mb)
