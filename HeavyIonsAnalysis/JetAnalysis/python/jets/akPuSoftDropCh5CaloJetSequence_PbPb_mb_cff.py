...
#akPuSoftDropCh5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))
...
akPuSoftDropCh5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh5CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDropCh5CaloJetSequence = cms.Sequence(akPuSoftDropCh5CaloJetSequence_mb)
