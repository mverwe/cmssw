...
#akCsSoftDropCh3PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiSignalGenJets'))

akCsSoftDropCh3PFbTagger = bTaggers("akCsSoftDropCh3PF",0.3)

#create objects locally since they dont load properly otherwise
#akCsSoftDropCh3PFmatch = akCsSoftDropCh3PFbTagger.match
akCsSoftDropCh3PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDropCh3PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akCsSoftDropCh3PFJetSequence = cms.Sequence(akCsSoftDropCh3PFJetSequence_jec)
akCsSoftDropCh3PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsSoftDropCh3PFJetAnalyzer.jetPtMin = cms.double(1)
