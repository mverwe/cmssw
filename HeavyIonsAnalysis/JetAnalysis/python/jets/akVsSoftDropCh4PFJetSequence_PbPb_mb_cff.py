...
#akVsSoftDropCh4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))

akVsSoftDropCh4PFbTagger = bTaggers("akVsSoftDropCh4PF",0.4)

#create objects locally since they dont load properly otherwise
#akVsSoftDropCh4PFmatch = akVsSoftDropCh4PFbTagger.match
akVsSoftDropCh4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh4PFJets"), matched = cms.InputTag("selectedPartons"))
...
akVsSoftDropCh4PFJetSequence = cms.Sequence(akVsSoftDropCh4PFJetSequence_mb)
