...
#akVsSoftDropCh3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiSignalGenJets'))
...
akVsSoftDropCh3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh3CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsSoftDropCh3CaloJetSequence = cms.Sequence(akVsSoftDropCh3CaloJetSequence_data)
