...
#akVsSoftDropCh4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiSignalGenJets'))

akVsSoftDropCh4PFbTagger = bTaggers("akVsSoftDropCh4PF",0.4)

#create objects locally since they dont load properly otherwise
#akVsSoftDropCh4PFmatch = akVsSoftDropCh4PFbTagger.match
akVsSoftDropCh4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh4PFJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsSoftDropCh4PFJetSequence = cms.Sequence(akVsSoftDropCh4PFJetSequence_jec)
akVsSoftDropCh4PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropCh4PFJetAnalyzer.jetPtMin = cms.double(1)
