...
#akSoftDropCh5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))

akSoftDropCh5PFbTagger = bTaggers("akSoftDropCh5PF",0.5)

#create objects locally since they dont load properly otherwise
#akSoftDropCh5PFmatch = akSoftDropCh5PFbTagger.match
akSoftDropCh5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh5PFJets"), matched = cms.InputTag("genParticles"))
