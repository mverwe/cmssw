...
#akSoftDropCh4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))

akSoftDropCh4PFbTagger = bTaggers("akSoftDropCh4PF",0.4)

#create objects locally since they dont load properly otherwise
#akSoftDropCh4PFmatch = akSoftDropCh4PFbTagger.match
akSoftDropCh4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh4PFJets"), matched = cms.InputTag("selectedPartons"))
...
akSoftDropCh4PFJetSequence = cms.Sequence(akSoftDropCh4PFJetSequence_mb)
