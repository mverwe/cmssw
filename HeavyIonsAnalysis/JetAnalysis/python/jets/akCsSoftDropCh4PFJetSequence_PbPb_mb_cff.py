...
#akCsSoftDropCh4PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))

akCsSoftDropCh4PFbTagger = bTaggers("akCsSoftDropCh4PF",0.4)

#create objects locally since they dont load properly otherwise
#akCsSoftDropCh4PFmatch = akCsSoftDropCh4PFbTagger.match
akCsSoftDropCh4PFparton = patJetPartonMatch.clone(src = cms.InputTag("akCsSoftDropCh4PFJets"), matched = cms.InputTag("selectedPartons"))
...
akCsSoftDropCh4PFJetSequence = cms.Sequence(akCsSoftDropCh4PFJetSequence_mb)
