...
#akPuSoftDropCh2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2GenJets'))

akPuSoftDropCh2PFbTagger = bTaggers("akPuSoftDropCh2PF",0.2)

#create objects locally since they dont load properly otherwise
#akPuSoftDropCh2PFmatch = akPuSoftDropCh2PFbTagger.match
akPuSoftDropCh2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh2PFJets"), matched = cms.InputTag("genParticles"))
...
akPuSoftDropCh2PFJetSequence = cms.Sequence(akPuSoftDropCh2PFJetSequence_data)
