...
#akSoftDropCh2PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2GenJets'))

akSoftDropCh2PFbTagger = bTaggers("akSoftDropCh2PF",0.2)

#create objects locally since they dont load properly otherwise
#akSoftDropCh2PFmatch = akSoftDropCh2PFbTagger.match
akSoftDropCh2PFparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh2PFJets"), matched = cms.InputTag("genParticles"))
...
akSoftDropCh2PFJetSequence = cms.Sequence(akSoftDropCh2PFJetSequence_data)
