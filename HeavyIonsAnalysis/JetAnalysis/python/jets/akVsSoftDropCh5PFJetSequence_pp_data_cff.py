...
#akVsSoftDropCh5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))

akVsSoftDropCh5PFbTagger = bTaggers("akVsSoftDropCh5PF",0.5)

#create objects locally since they dont load properly otherwise
#akVsSoftDropCh5PFmatch = akVsSoftDropCh5PFbTagger.match
akVsSoftDropCh5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh5PFJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDropCh5PFJetSequence = cms.Sequence(akVsSoftDropCh5PFJetSequence_data)
