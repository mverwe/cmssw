...
#akVsSoftDropCh1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1GenJets'))
...
akVsSoftDropCh1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh1CaloJets"), matched = cms.InputTag("genParticles"))
