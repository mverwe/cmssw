...
#akVsSoftDropCh5Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5GenJets'))
...
akVsSoftDropCh5Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh5CaloJets"), matched = cms.InputTag("genParticles"))
...
akVsSoftDropCh5CaloJetSequence = cms.Sequence(akVsSoftDropCh5CaloJetSequence_jec)
akVsSoftDropCh5CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropCh5CaloJetAnalyzer.jetPtMin = cms.double(1)
