...
#akVsSoftDropCh6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiSignalGenJets'))
...
akVsSoftDropCh6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh6CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsSoftDropCh6CaloJetSequence = cms.Sequence(akVsSoftDropCh6CaloJetSequence_jec)
akVsSoftDropCh6CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropCh6CaloJetAnalyzer.jetPtMin = cms.double(1)
