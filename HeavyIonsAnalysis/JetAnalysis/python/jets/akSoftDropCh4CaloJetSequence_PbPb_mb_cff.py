...
#akSoftDropCh4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiCleanedGenJets'))

akSoftDropCh4CalobTagger = bTaggers("akSoftDropCh4Calo",0.4)

#create objects locally since they dont load properly otherwise
#akSoftDropCh4Calomatch = akSoftDropCh4CalobTagger.match
akSoftDropCh4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh4CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akSoftDropCh4CaloJetSequence = cms.Sequence(akSoftDropCh4CaloJetSequence_mb)
