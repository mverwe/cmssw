...
#akVsSoftDropCh1Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak1HiSignalGenJets'))
...
akVsSoftDropCh1Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akVsSoftDropCh1CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akVsSoftDropCh1CaloJetSequence = cms.Sequence(akVsSoftDropCh1CaloJetSequence_jec)
akVsSoftDropCh1CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akVsSoftDropCh1CaloJetAnalyzer.jetPtMin = cms.double(1)
