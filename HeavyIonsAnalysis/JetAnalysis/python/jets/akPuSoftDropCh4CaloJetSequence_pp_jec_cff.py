...
#akPuSoftDropCh4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4GenJets'))
...
akPuSoftDropCh4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh4CaloJets"), matched = cms.InputTag("genParticles"))
...
akPuSoftDropCh4CaloJetSequence = cms.Sequence(akPuSoftDropCh4CaloJetSequence_jec)
akPuSoftDropCh4CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akPuSoftDropCh4CaloJetAnalyzer.jetPtMin = cms.double(1)
