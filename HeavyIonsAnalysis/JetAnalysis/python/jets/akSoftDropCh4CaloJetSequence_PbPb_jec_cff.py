...
#akSoftDropCh4Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak4HiSignalGenJets'))

akSoftDropCh4CalobTagger = bTaggers("akSoftDropCh4Calo",0.4)

#create objects locally since they dont load properly otherwise
#akSoftDropCh4Calomatch = akSoftDropCh4CalobTagger.match
akSoftDropCh4Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akSoftDropCh4CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akSoftDropCh4CaloJetSequence = cms.Sequence(akSoftDropCh4CaloJetSequence_jec)
akSoftDropCh4CaloJetAnalyzer.genPtMin = cms.untracked.double(1)
akSoftDropCh4CaloJetAnalyzer.jetPtMin = cms.double(1)
