...
#akPuSoftDropCh5PFclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak5HiCleanedGenJets'))

akPuSoftDropCh5PFbTagger = bTaggers("akPuSoftDropCh5PF",0.5)

#create objects locally since they dont load properly otherwise
#akPuSoftDropCh5PFmatch = akPuSoftDropCh5PFbTagger.match
akPuSoftDropCh5PFparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh5PFJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDropCh5PFJetSequence = cms.Sequence(akPuSoftDropCh5PFJetSequence_mb)
