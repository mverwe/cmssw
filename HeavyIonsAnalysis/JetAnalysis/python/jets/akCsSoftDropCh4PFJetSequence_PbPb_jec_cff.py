...
akCsSoftDropCh4PFJetSequence = cms.Sequence(akCsSoftDropCh4PFJetSequence_jec)
akCsSoftDropCh4PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akCsSoftDropCh4PFJetAnalyzer.jetPtMin = cms.double(1)
