...
#akPuSoftDropCh2Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak2HiCleanedGenJets'))
...
akPuSoftDropCh2Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh2CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDropCh2CaloJetAnalyzer = inclusiveJetAnalyzer.clone(jetTag = cms.InputTag("akPuSoftDropCh2CalopatJetsWithBtagging"),
                                                             genjetTag = 'ak2HiCleanedGenJets',#'ak2HiGenJets',
                                                             rParam = 0.2,
...
akPuSoftDropCh2CaloJetSequence = cms.Sequence(akPuSoftDropCh2CaloJetSequence_mb)
