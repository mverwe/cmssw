...
#akPuSoftDropCh6Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak6HiSignalGenJets'))
...
akPuSoftDropCh6Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh6CaloJets"), matched = cms.InputTag("hiSignalGenParticles"))
...
akPuSoftDropCh6CaloJetSequence = cms.Sequence(akPuSoftDropCh6CaloJetSequence_data)
