...
#akPuSoftDropCh3Caloclean   = heavyIonCleanedGenJets.clone(src = cms.InputTag('ak3HiCleanedGenJets'))
...
akPuSoftDropCh3Caloparton = patJetPartonMatch.clone(src = cms.InputTag("akPuSoftDropCh3CaloJets"), matched = cms.InputTag("selectedPartons"))
...
akPuSoftDropCh3CaloJetSequence = cms.Sequence(akPuSoftDropCh3CaloJetSequence_mb)
