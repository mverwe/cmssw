...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring(
                                'file:/eos/cms/store/cmst3/group/hintt/Pbp/PYQUEN_TTbar/PbP/Events_99.root'
...
from GeneratorInterface.RivetInterface.genParticles2HepMC_cfi import genParticles2HepMC   #class: GenParticles2HepMCConverter
#from GeneratorInterface.RivetInterface.genParticles2HepMC_cff import genParticles2HepMC   #class: GenParticles2HepMCConverter
...
process.pseudoTop.minJetPt = cms.double(25.)

from TopQuarkAnalysis.TopAnalyzers.TopGenAnalyzer_cfi import topGenAnalyzer
process.topGenAnalyzer = topGenAnalyzer.clone()
